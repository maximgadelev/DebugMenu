...
class DebugMenuDialogFragment : MvpAppCompatDialogFragment(), DebugMenuView, HBRecorderListener {
    ...
    private fun setupViews() {
        with(binding) {
            ...
            toolbar.apply {
                ...
                setNavigationOnClickListener { this@DebugMenuDialogFragment.dismiss() }
            }
        }
    }
