...
class DebugMenuBottomDialogFragment() : MvpBottomSheetDialogFragment(), DebugMenuView,
    HBRecorderListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupViews()
        val views =
            arguments?.getParcelableArray(KEY_VIEWS) as Array<ru.kpfu.itis.debugmenu.feature.own_functionality.debugMenuView.DebugMenuView>
    ...
    private fun setupViews() {
        with(binding) {
            ...
            toolbar.apply {
                ...
                setNavigationOnClickListener { this@DebugMenuBottomDialogFragment.dismiss() }
            }
        }
    }
    ...
    companion object {
        ...
        fun newInstance(
            ...
            DebugMenuBottomDialogFragment().apply {
                arguments = bundleOf(
